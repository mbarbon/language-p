...
our %PROTOTYPE =
  ( OP_PRINT()       => [  0, -1, PROTO_FILEHANDLE, PROTO_ARRAY ],
    ...
    OP_ARRAY_PUSH()  => [  1, -1, 0, PROTO_ARRAY|PROTO_REFERENCE, PROTO_ARRAY ],
    OP_ARRAY_UNSHIFT()=>[  1, -1, 0, PROTO_ARRAY|PROTO_REFERENCE, PROTO_ARRAY ],
    OP_ARRAY_POP()   => [  1,  1, 0, PROTO_ARRAY|PROTO_REFERENCE ],
    OP_ARRAY_SHIFT() => [  1,  1, 0, PROTO_ARRAY|PROTO_REFERENCE ],
    );
