...
my %prec_assoc_bin =
  ( # T_ARROW()           => [ 2,  ASSOC_LEFT ],
    ...
    T_AMPERSANDEQUAL()  => [ 19, ASSOC_RIGHT, OP_BIT_AND_EQUAL ],
    T_OREQUAL()         => [ 19, ASSOC_RIGHT, OP_BIT_OR_EQUAL ],
    T_XOREQUAL()        => [ 19, ASSOC_RIGHT, OP_BIT_XOR_EQUAL ],
    T_ANDANDEQUAL()     => [ 19, ASSOC_RIGHT, OP_LOG_AND_EQUAL ],
    T_OROREQUAL()       => [ 19, ASSOC_RIGHT, OP_LOG_OR_EQUAL ],
