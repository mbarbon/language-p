...
jump_if_f_eq        0       same                 2   0  to=b,class=Jump
jump_if_f_ge        0       same                 2   0  to=b,class=Jump
jump_if_f_gt        0       same                 2   0  to=b,class=Jump
jump_if_f_le        0       same                 2   0  to=b,class=Jump
jump_if_f_lt        0       same                 2   0  to=b,class=Jump
jump_if_f_ne        0       same                 2   0  to=b,class=Jump
jump_if_false       0       same                 1   0  to=b,class=Jump
jump_if_null        0       same                 1   0  to=b,class=Jump
jump_if_s_eq        0       same                 2   0  to=b,class=Jump
jump_if_s_ge        0       same                 2   0  to=b,class=Jump
jump_if_s_gt        0       same                 2   0  to=b,class=Jump
jump_if_s_le        0       same                 2   0  to=b,class=Jump
jump_if_s_lt        0       same                 2   0  to=b,class=Jump
jump_if_s_ne        0       same                 2   0  to=b,class=Jump
jump_if_true        0       same                 1   0  to=b,class=Jump
keys                u       same                 1   1  context=i1
lc                  u       same                 1   1  noattr
lcfirst             u       same                 1   1  noattr
length              u       same                 1   1  noattr
lexical             0       same                 0   1  index=ls,class=Lexical
lexical_clear       0       same                 0   0  index=ls,class=Lexical
lexical_pad         0       same                 0   1  index=lp,class=Lexical
lexical_pad_clear   0       same                 0   0  index=lp,class=Lexical
lexical_pad_set     0       same                 1   0  index=lp,class=Lexical
lexical_set         0       same                 1   0  index=ls,class=Lexical
...
localize_lexical    0       same                 0   0  lexical=ls,index=i,class=LocalLexical
localize_lexical_pad 0      same                 0   0  lexical=lp,index=i,class=LocalLexical
...
restore_lexical     0       same                 0   0  lexical=ls,index=i,class=LocalLexical
restore_lexical_pad 0       same                 0   0  lexical=lp,index=i,class=LocalLexical
...
rx_exact            0       same                 0   0  string=s,length=i,class=RegexExact
rx_exact_i          0       same                 0   0  string=s,length=i,class=RegexExact
