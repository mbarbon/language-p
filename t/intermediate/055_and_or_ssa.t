...
L2: # scope=1
  ...
  jump to=L3
L3: # scope=1
  set index=3, slot=VALUE_SCALAR (phi L2, 2, VALUE_SCALAR, L4, 1, VALUE_SCALAR)
...
L5: # scope=1
  ...
  jump to=L6
L6: # scope=1
  set index=5, slot=VALUE_SCALAR (phi L5, 4, VALUE_SCALAR, L7, 3, VALUE_SCALAR)
...
L2: # scope=1
  ...
  jump to=L3
L3: # scope=1
  set index=4, slot=VALUE_SCALAR (phi L4, 1, VALUE_SCALAR, L2, 3, VALUE_SCALAR)
