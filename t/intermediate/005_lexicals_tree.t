...
L1: # scope=1
  ...
  assign context=CXT_VOID (lexical index=0, slot=VALUE_ARRAY), (make_list context=CXT_LIST|CXT_LVALUE (lexical index=1, slot=VALUE_SCALAR), (lexical index=2, slot=VALUE_SCALAR))
